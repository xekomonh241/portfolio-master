    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-base text-gray-400 tracking-wide">
          I would like to join your company as an intern. If you have
          recruitment needs, please contact me.
        </p>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className="text-lightText">nguyenducmanh1101@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          <a
            href="https://www.facebook.com/ducmanh1101/"
          ...
          <a
            href="https://www.instagram.com/duc.manguyn/"
            className="bannerIcon"
          >
            <FaInstagram />
          </a>
